...
//     }
//     if (progress > 0) {
//       return { text: "In Progress", color: "#f59e0b", bg: "#fef3c7", icon: <FaChartLine /> };
//     }
...
//             <h2 style={styles.enrollTitle}>Enroll in New Course</h2>
...
//                     style={{
//                       ...styles.courseCard,
//                       transform: locked ? 'none' : 'translateY(0)',
//                       ':hover': locked ? {} : { transform: 'translateY(-4px)' }
//                     }}
//                   >
...
//     } else if (isPaid) {
//       return { type: "paid_unlocked", label: "Paid (Unlocked)", icon: <FaUnlock />, color: "#3b82f6", bg: "#dbeafe" };
//     } else {
