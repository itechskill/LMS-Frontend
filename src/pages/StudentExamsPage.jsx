      ...
      <div style={{ display: "flex", minHeight: "100vh" }}>
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <h2 style={{ color: COLORS.danger, marginBottom: "16px", fontSize: "24px" }}>Authentication Error</h2>
            <p style={{ color: COLORS.textGray, marginBottom: "24px", fontSize: "16px", lineHeight: 1.6 }}>
        ...
        <div style={{ 
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ fontSize: isMobile ? "12px" : "14px", color: COLORS.info, fontWeight: "600" }}>
                Total Exams
              </div>
              <div style={{ fontSize: isMobile ? "24px" : "28px", fontWeight: "700", color: COLORS.deepPurple }}>
                {exams.length}
              </div>
            </div>
            <div style={{
              background: "linear-gradient(135deg, rgba(0, 217, 163, 0.1) 0%, rgba(13, 148, 136, 0.1) 100%)",
              padding: "16px",
              borderRadius: "12px",
              border: "1px solid rgba(0, 217, 163, 0.2)"
            }}>
              <div style={{ fontSize: isMobile ? "12px" : "14px", color: COLORS.brightGreen, fontWeight: "600" }}>
                Passed
              </div>
              <div style={{ fontSize: isMobile ? "24px" : "28px", fontWeight: "700", color: COLORS.deepPurple }}>
                {exams.filter(exam => getExamStatus(exam) === "PASS").length}
              </div>
            </div>
            <div style={{
              ...
              <div style={{ fontSize: isMobile ? "12px" : "14px", color: COLORS.danger, fontWeight: "600" }}>
                Failed
              </div>
              <div style={{ fontSize: isMobile ? "24px" : "28px", fontWeight: "700", color: COLORS.deepPurple }}>
                {exams.filter(exam => getExamStatus(exam) === "FAIL").length}
              </div>
            </div>
            <div style={{
              ...
              <div style={{ fontSize: isMobile ? "12px" : "14px", color: COLORS.warning, fontWeight: "600" }}>
                Pending
              </div>
              <div style={{ fontSize: isMobile ? "24px" : "28px", fontWeight: "700", color: COLORS.deepPurple }}>
                {exams.filter(exam => getExamStatus(exam) === "Pending").length}
              </div>
            </div>
          </div>
        </div>
          ...
          {filteredExams.length === 0 ? (
            <div style={{
              ...
              <h3 style={{ color: COLORS.deepPurple, fontSize: "20px", marginBottom: "12px", fontWeight: "700" }}>
                {searchTerm || filterStatus !== "all" ? "No matching exams found" : "No Exams Available"}
              </h3>
