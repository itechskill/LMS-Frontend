...
// Use the same color theme as AdminMessages
const COLORS = {
  sidebarDark: "#1a1d2e",
  deepPurple: "#3D1A5B",
  headerPurple: "#4B2D7A",
  ...
  indigo: "#4f46e5",
  rose: "#f43f5e",
  myMessageBg: "#00D9A3", // Changed to bright green for student messages
...
const StudentMessages = () => {
  ...
  const fetchAdmins = async () => {
    try {
      ...
      // Filter to show only admins and add mock data for demo
  ...
  useEffect(() => {
    ...
    socket.on("typing", (data) => {
      if (data.userId === selectedAdmin) {
        setTypingStatus(prev => ({
          ...prev,
          [selectedAdmin]: data.isTyping
        }));
      }
    });
  ...
  const selectAdmin = (admin) => {
    ...
    setTypingStatus(prev => ({ ...prev, [admin._id]: false }));
  };
  ...
  // Clear all messages with admin
  const clearChat = () => {
    if (!selectedAdmin) return;
    const confirmed = window.confirm("Clear all messages with this admin?");
    if (!confirmed) return;
    setMessages([]);
  };
      ...
      <div style={{
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            {/* Chat List Header */}
            <div style={{ 
              background: "linear-gradient(135deg, #00D9A3 0%, #10b981 100%)", 
            ...
            <div style={{ 
              ...
              {loading && admins.length === 0 ? (
                ...
                filteredAdmins.map((a) => {
                  const isSelected = selectedAdmin === a._id;
                  ...
                  return (
                    <div 
                      ...
                      style={{ 
                        ...
                        padding: "18px 20px", 
                        cursor: "pointer", 
                        background: isSelected ? "linear-gradient(90deg, rgba(0, 217, 163, 0.1) 0%, rgba(16, 185, 129, 0.08) 100%)" : COLORS.white, 
                        borderBottom: `1px solid ${COLORS.lightGray}`,
                        transition: "all 0.3s ease",
                        borderLeft: isSelected ? `4px solid ${COLORS.brightGreen}` : "none",
                        position: "relative",
                        ":hover": {
                          background: isSelected ? "linear-gradient(90deg, rgba(0, 217, 163, 0.1) 0%, rgba(16, 185, 129, 0.08) 100%)" : COLORS.bgGray
                        }
                      }}
                    >
                      {/* Admin Avatar */}
                      <div style={{ position: "relative" }}>
                        <div style={{ 
                          ...
                          height: "52px", 
                          borderRadius: "12px", 
                          background: `linear-gradient(135deg, ${COLORS.brightGreen} 0%, #10b981 100%)`, 
                          display: "flex", 
                          alignItems: "center", 
                          justifyContent: "center", 
                          color: COLORS.white, 
                          ...
                          fontSize: "20px",
                          flexShrink: 0,
                          boxShadow: "0 4px 8px rgba(0, 217, 163, 0.2)"
                        }}>
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <div style={{ 
                          ...
                          {isOnline ? "Online" : `Last seen ${formatMessageTime(a.lastSeen)}`}
                        </div>
                      </div>
            ...
            <div style={{ 
              ...
              <div style={{ 
                ...
                <div>
                  <div style={{ fontWeight: "600", color: COLORS.deepPurple }}>
                    {user?.fullName || "Student"}
                  </div>
                  <div style={{ fontSize: "11px" }}>You</div>
                </div>
              </div>
              <div style={{ 
                fontSize: "13px", 
            ...
            {selectedAdmin ? (
                    ...
                    {isMobile && (
                      <button
                        ...
                        style={{
                          ...
                          justifyContent: "center",
                          transition: "all 0.3s ease",
                          boxShadow: "0 2px 8px rgba(0, 217, 163, 0.2)"
                        }}
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                      <div style={{ position: "relative" }}>
                        ...
                        <div style={{
                          ...
                          height: "16px",
                          borderRadius: "50%",
                          background: selectedAdminObj?.isOnline ? COLORS.onlineGreen : COLORS.offlineGray,
                      ...
                      <div>
                        <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "4px" }}>
                          ...
                          <span style={{
                            background: selectedAdminObj?.isOnline ? COLORS.greenLight : COLORS.lightGray,
                            color: selectedAdminObj?.isOnline ? "#065f46" : COLORS.darkGray,
                            padding: "4px 10px",
                            borderRadius: "6px",
                            fontSize: "11px",
                            fontWeight: "600",
                            ...
                            {selectedAdminObj?.isOnline ? "Online" : "Offline"}
                          </span>
                        </div>
                        ...
                        <div style={{ 
                          ...
                          <span style={{
                            ...
                            {selectedAdminObj?.role || "Admin"}
                          </span>
                          <span style={{ display: "flex", alignItems: "center", gap: "4px" }}>
                            <FaUserCircle size={12} /> {selectedAdminObj?.email || "No email"}
                          </span>
                        </div>
                      </div>
                    </div>
                ...
                <div style={{ 
                  ...
                  <button 
                    ...
                    style={{ 
                      ...
                      borderRadius: "16px", 
                      border: "none", 
                      background: text.trim() ? `linear-gradient(135deg, ${COLORS.brightGreen} 0%, #10b981 100%)` : COLORS.lightGray, 
                      color: COLORS.white, 
                      ...
                      transition: "all 0.3s ease",
                      fontSize: "20px",
                      boxShadow: text.trim() ? "0 4px 12px rgba(0, 217, 163, 0.3)" : "none"
                    }}
                    onMouseEnter={(e) => {
                      if (text.trim()) {
                        e.currentTarget.style.transform = "translateY(-2px)";
                        e.currentTarget.style.boxShadow = "0 6px 16px rgba(0, 217, 163, 0.4)";
                      }
                    }}
                    onMouseLeave={(e) => {
                      if (text.trim()) {
                        e.currentTarget.style.transform = "translateY(0)";
                        e.currentTarget.style.boxShadow = "0 4px 12px rgba(0, 217, 163, 0.3)";
                      }
                    }}
                  >
                    <FaPaperPlane />
              ...
              <div style={{ 
                ...
                <div style={{ 
                  ...
                  height: "140px",
                  borderRadius: "24px",
                  background: `linear-gradient(135deg, rgba(0, 217, 163, 0.1) 0%, rgba(16, 185, 129, 0.08) 100%)`,
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  fontSize: "60px",
                ...
                <div>
                  ...
                  <p style={{ 
                    ...
                    Select an admin from the sidebar to start messaging.
                    Get support, ask questions, and communicate with administrators.
                  </p>
                </div>
                {isMobile && (
                  <button
                    ...
                    style={{
                      ...
                      gap: "12px",
                      transition: "all 0.3s ease",
                      boxShadow: "0 8px 24px rgba(0, 217, 163, 0.3)"
                    }}
                    onMouseEnter={(e) => {
                      e.currentTarget.style.transform = "translateY(-4px)";
                      e.currentTarget.style.boxShadow = "0 12px 28px rgba(0, 217, 163, 0.4)";
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.transform = "translateY(0)";
                      e.currentTarget.style.boxShadow = "0 8px 24px rgba(0, 217, 163, 0.3)";
                    }}
                  >
                    <FaUsers size={18} /> View All Admins
                  </button>
                )}
              </div>
            )}
