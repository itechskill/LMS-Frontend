...
const Courses = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // ✅ VALIDATION: Subcategories required
    if (formData.subCategories.length === 0) {
      alert("Please select at least one subcategory for the course!");
      return;
    }
          ...
          <div style={{ width: "100%" }}>
            ...
            >
              ...
              <div>
                ...
                {/* ✅ WARNING: No subcategory selected */}
                {formData.category && formData.subCategories.length === 0 && (
                  <div style={{
                    ...
                    <strong>Required:</strong> Please select at least one subcategory for this course
                  </div>
                )}
                ...
                {/* ✅ IMPROVED: Show selected subcategories with count */}
